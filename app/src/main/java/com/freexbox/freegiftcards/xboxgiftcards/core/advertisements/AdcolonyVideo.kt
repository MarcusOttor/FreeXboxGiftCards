...
class AdcolonyVideo {
    ...
    fun init(activity: Activity) {
        AdColony.configure(activity, "app74af59a09d57431a97", "vzaf6bae5bac584a2e9b")
    ...
    fun onResume(activity: Activity) {
        if (adcolonyVideo == null || adcolonyVideo!!.isExpired) {
            AdColony.requestInterstitial("vzaf6bae5bac584a2e9b",
                ...
                override fun onExpiring(ad: AdColonyInterstitial?) {
                    super.onExpiring(ad)
                    AdColony.requestInterstitial("vzaf6bae5bac584a2e9b", this)
                }
            })
        }
    }
